...
<br>
           <div class="row" style="margin-bottom: 15px;">
                ...
                <div class="col-sm-6 text-right">
                    <a href="<?php echo base_url();?>index.php?admin/export_list/accountant/excel" target="_blank" class="btn btn-info btn-sm">Excel</a>
                    <a href="<?php echo base_url();?>index.php?admin/export_list/accountant/pdf" target="_blank" class="btn btn-danger btn-sm">PDF</a>
                    <a href="<?php echo base_url();?>index.php?admin/export_list/accountant/print" target="_blank" class="btn btn-default btn-sm">Print</a>
                </div>
            </div>
