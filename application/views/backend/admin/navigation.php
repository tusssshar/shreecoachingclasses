<div class="sidebar-menu">
            ...
            <ul>
                ...
                <!-- STUDENT INFORMATION -->
                 <li class="<?php if ($page_name == 'student_information' || $page_name == 'student_marksheet') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/student_information/2">
 ...
 <!-- MEDIA -->
        ...
        */ ?>
		 ...
		 <li class="<?php if ($page_name == 'teacher_id_card' || $page_name == 'student_id_card') echo 'opened active'; ?> ">
            <a href="#">
                <i class="entypo-book"></i>
...
<!-- AASIGNMENTS -->
        ...
        ?> ">
            ...
            <ul>
                <?php /* Create Student Payment menu hidden
