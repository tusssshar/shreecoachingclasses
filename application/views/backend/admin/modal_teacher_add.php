			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/teacher/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="designation" placeholder="e.g. Senior Teacher">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="number" step="1" min="0" class="form-control" id="basic_salary" name="basic_salary" value="0" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3"><input type="number" class="form-control" id="hra" name="hra" value="0" readonly></div>
                        <label class="col-sm-2 control-label">DA <span class="label label-info"><?php echo $salary_pct['da']; ?>% of Basic</span></label>
                        <div class="col-sm-3"><input type="number" class="form-control" id="da" name="da" value="0" readonly></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-3"><input type="number" class="form-control" id="conveyance" name="conveyance" value="0" readonly></div>
                        ...
                        <div class="col-sm-3"><input type="number" class="form-control" id="medical_allowance" name="medical_allowance" value="0" readonly></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-3"><input type="number" class="form-control" id="other_allowance" name="other_allowance" value="0" readonly></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3"><input type="number" class="form-control" id="other_deduction" name="other_deduction" value="0" readonly></div>
                    </div>
