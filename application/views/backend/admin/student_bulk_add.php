                ...
                <?php echo form_open(base_url() . 'index.php?admin/student_bulk_add/import_excel/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
                         ...
                         <p class="help-block" style="margin-top:10px;">Use the same student fields as the add-student page. If the spreadsheet includes an existing <strong>student_id</strong>, that student will be updated instead of creating a new record.</p>
						</div>
					</div>
